...
public enum ArmyType {
    ...
    PEGASI  ("Pegasi",          new int[] { 1,  1,  2,  2,  2,  2,  3,  2,  2,  2,  1,  2},  1,  0,  0),
    GRIFFINS("Griffins",        new int[] { 1,  1,  2,  2,  2,  2,  3,  2,  2,  2,  1,  2},  0,  1,  0),
    WIZARDS ("Wizards",         new int[] { 1,  1, -1, -1,  4,  6, -1,  2,  5,  2,  1,  2},  0,  0,  0),
    UNDEAD  ("Undead",          new int[] { 1,  1, -1, -1,  4,  5, -1,  2,  4,  2,  1,  2}, -1,  0,  1),
    DRAGONS ("Dragons",         new int[] { 1,  1,  2,  2,  2,  2,  3,  2,  2,  2,  1,  2},  0,  0,  0),
